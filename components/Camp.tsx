...
const Camp = () => {
  return (
    ...
    relatif flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
        <div className='hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
          ...
          subtitle = 'Singgalang, Agam'
          peopleJoined = '200+ Joined'
          />

           <CampSite
          backgroundImage = "bg-bg-img-1"
          title = 'Puncak Lawang Camp'
          subtitle = 'Prigen, Pasuruan'
          ...
          backgroundImage = "bg-bg-img-2"
          title = 'Mountain View Camp'
          subtitle = 'Marapi,Sumbar'
          peopleJoined = '56+ Joined'
          />
        </div>
            ...
            relative w-full overflow-hidden rounded-3xl " > 
                ...
                <p className="regular-14 xl:regular-16 mt-5 text-white">
                  ...
                  the possibility of getting lost is very large.
                   That's why we are here for those of 

  ...
  return (
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row '>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        ...
        We can help you on an adventure around the world in just 
        one app
        </p>
        <div className='my-11 flex-wrap gap-5 '>
          ...
          <p className='bold-16 lg:bold-20 text-blue-70'>
            198K
            <span className='reguler-16 lg:reguler-20 ml-1 '>Excelent Reviews</span>
          </p>
        </div>
            ...
            <div className='relative  z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8 '>
              ...
              <div className='flex flex-col '>
                  <div className='flexBetween'>
                      <p className='reguler-16 text-gray-20'>
                      Location 
                      </p>
                      <Image
                      src='/close.svg'
                      ...
                      <p className='bold-20 text-white'>Gunuang Marapi</p>
              </div>
              ...
              <div className='flexBetween'>
                  ...
                  <div className='flex flex-col'>
                          ...
                          <p className='bold-20 text-white'>2.884 km</p>
                  </div>
              </div>
            </div>
        </div>
